...
\title{First Extragalactic Exoplanets\\ Thanks to Higher Cadence Observations of SMC}
...
in achieving our science goals, we propose {\it figure of merit} (FoM), 
which is a number of SMC planets discovered.  The number is evaluated 
assuming fiducial planet frequency and taking into account the follow-up
...
$q$ --- the star-planet mass ratio, and
$s$ --- the star-planet separation projected on the plane of the sky and divided by Einstein ring radius.  % XXX defined before?
Einstein ring radius is a characteristic angular scale of microlensing events.  
...
As a result, projected separations in SMC that are probed by microlensing are similar 
to values in Galactic bulge fields.  
% XXX - lens masses
We may expect that planet frequency is lower in SMC, but for 
calculating FoM, we assume the same as in the Galactic bulge 
