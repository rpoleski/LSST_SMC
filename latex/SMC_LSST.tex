...
observations from smaller telescopes.  The SMC is elongated along the 
line-of-sight and the microlensing events 
observed toward the SMC are almost exclusively self-lensing, i.e., 
both the lens and the source are in the SMC \citep{sahu98,wyrzykowski11b}.  
